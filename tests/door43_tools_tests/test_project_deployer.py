...
from services.client.preprocessors import TqPreprocessor
from services.client.preprocessors import TnPreprocessor
from tools.door43_tools.project_deployer import ProjectDeployer
from tools.door43_tools.td_language import TdLanguage
from tools.general_tools import file_utils
from tools.general_tools.file_utils import unzip
from tools.door43_tools.bible_books import BOOK_NUMBERS
...
class ProjectDeployerTests(unittest.TestCase):
    ...
    def test_tn_deploy_revision_to_door43(self):
        ...
        # then
        self.assertTrue(ret)
        self.assertTrue(App.door43_s3_handler().key_exists('{0}/build_log.json'.format(self.project_key)))
