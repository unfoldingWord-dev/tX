...
from services.lambda_handlers.door43_print_handler import Door43PrintHandler


class TestDoor43PrintHandler(TestCase):

    @mock.patch('tools.door43_tools.project_printer.ProjectPrinter.print_project')
