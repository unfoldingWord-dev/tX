...
from services.lambda_handlers.lint_handler import LintHandler
from services.linters.markdown_linter import MarkdownLinter


class TestLintHandler(TestCase):

    @mock.patch('services.linters.linter.Linter.run')
