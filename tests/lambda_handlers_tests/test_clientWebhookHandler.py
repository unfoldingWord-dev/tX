...
from services.lambda_handlers.client_webhook_handler import ClientWebhookHandler


class TestClientWebhookHandler(TestCase):

    @mock.patch('services.client.client_webhook.ClientWebhook.process_webhook')
