...
from services.lambda_handlers.client_converter_callback_handler import ClientConverterCallbackHandler


@mock_s3
class TestClientConverterCallbackHandler(TestCase):

    @mock.patch('services.client.client_converter_callback.ClientConverterCallback.process_callback')
    ...
    @mock.patch('services.client.client_linter_callback.ClientLinterCallback.process_callback')
