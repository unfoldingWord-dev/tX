...
from services.lambda_handlers.page_view_count_handler import PageViewCountHandler
...
class ViewCountHandlerTest(TestCase):
    ...
    @mock.patch('tools.door43_tools.page_metrics.PageMetrics.get_view_count')
