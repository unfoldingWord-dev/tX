...
from services.lambda_handlers.door43_deploy_handler import Door43DeployHandler
...
class TestDoor43DeployerHandler(TestCase):
    ...
    @mock.patch('tools.door43_tools.project_deployer.ProjectDeployer.deploy_revision_to_door43')
    ...
    @mock.patch('tools.door43_tools.project_deployer.ProjectDeployer.redeploy_all_projects')
