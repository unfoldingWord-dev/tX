...
from services.lambda_handlers.language_view_count_handler import LanguageViewCountHandler
...
class LanguageViewCountHandlerTest(TestCase):
    ...
    @mock.patch('tools.door43_tools.page_metrics.PageMetrics.get_language_view_count')
